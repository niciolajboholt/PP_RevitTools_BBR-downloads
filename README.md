...
**[⬇ Hent v0.6.0 under Releases](../../releases)**

Hent `PP_RevitTools_BBR_v0.6.0_Setup.exe`. PDF-vejledningen er indlejret i
installationen, men kan også hentes separat fra samme release. `.sha256`-filen
kan bruges til at kontrollere, at filen er hentet korrekt.

Versioner før v1.0.0 er beta. Test gerne først i en kopi af en projektmodel.
...
- Fordeler adgangsarealer på boliger og erhvervsenheder og fællesboligarealer
  på boliger.
...
- Foreslår klassifikation ud fra Area-navne (trapperum, altangang, fællessal,
  cykelparkering, butik, bolig m.fl.).
...
- Viser alle resultater i et preview med etage og opdelt adgangs- og
  fællesboligtillæg, før noget skrives.
- Eksporterer beregningsgrundlaget til en Excel-venlig CSV-fil.
- Kan erstatte en ugyldig parameter med den officielle P+P-parameter
  (**Erstat**) efter tydelig advarsel.
...
6. Vælg **Gem og genberegn**, og kontrollér gruppeoversigt og
   bolig/erhverv-preview. Gem evt. en CSV-eksport.
...
Ved opdatering køres den nye installationsfil blot oven på den gamle.
Installationsfilen er ikke digitalt signeret, så Windows kan vise en advarsel
...
- **Erstat** fjerner en ugyldig parameter fra alle kategorier, den er bundet
  til – kontrollér bindingen først og brug en sikkerhedskopi.
